 ...
 */
class DigitalMapView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyle: Int = 0) :
    ...
    private var mEdgeEffectLeft: EdgeEffectCompat = EdgeEffectCompat(context)
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        setMeasuredDimension(
            Math.max(
                ...
                resolveSize(
                    minChartSize + paddingLeft + mMaxLabelWidth
            ...
            Math.max(
                ...
                resolveSize(
                    (minChartSize + paddingTop + mLabelHeight
    ...
    private val mScaleGestureListener: OnScaleGestureListener = object : SimpleOnScaleGestureListener() {
        ...
        override fun onScale(scaleGestureDetector: ScaleGestureDetector): Boolean {
            ...
            constrainViewport()
            ViewCompat.postInvalidateOnAnimation(this@DigitalMapView)
            lastSpanX = spanX
            lastSpanY = spanY
            return true
        }
    ...
    override fun computeScroll() {
        ...
        if (mZoomer.computeZoom()) {
            ...
            mCurrentViewport[mZoomFocalPoint.x - newWidth * pointWithinViewportX, mZoomFocalPoint.y - newHeight * pointWithinViewportY, mZoomFocalPoint.x + newWidth * (1 - pointWithinViewportX)] =
    ...
    private fun setViewportBottomLeft(x: Float, y: Float) {
        ...
        mCurrentViewport[x, y - curHeight, x + curWidth] = y
        ViewCompat.postInvalidateOnAnimation(this)
    }
    ////////////////////////////////////////////////////////////////////////////////////////////////
    //
    ...
    public override fun onRestoreInstanceState(state: Parcelable) {
        ...
        mCurrentViewport = ss.viewport ?: RectF(AXIS_X_MIN, AXIS_Y_MIN, AXIS_X_MAX, AXIS_Y_MAX)
    }
    ...
    companion object {
         ...
         * @see .panDown
         */
        private val PAN_VELOCITY_FACTOR = 2f
         ...
         */
        private fun formatFloat(out: CharArray, `val`: Float, digits: Int): Int {
            var `val` = `val`
            var digits = digits
            var negative = false
            if (`val` == 0f) {
            ...
            `val` *= POW10[digits]
            var lval = Math.round(`val`).toLong()
